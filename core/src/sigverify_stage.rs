...
struct SigVerifierStats {
    ...
    max_post_send_len: Arc<AtomicUsize>,
...
impl SigVerifierStats {
    ...
    fn maybe_report_and_reset(&mut self, name: &'static str) {
        ...
        datapoint_info!(
            ...
            (
                "max_post_send_len",
                self.max_post_send_len.swap(0, Ordering::Relaxed) as i64,
                i64
            ),
            (
                "eviction_drops",
        ...
        let worker_pool = SigVerifyWorkerPool::new(
            ...
            SigVerifyWorkerState::new(
                ...
                SigVerifyWorkerStats {
                    ...
                    max_post_send_len: non_vote_stats.max_post_send_len.clone(),
            ...
            SigVerifyWorkerState::new(
                ...
                SigVerifyWorkerStats {
                    ...
                    max_post_send_len: tpu_vote_stats.max_post_send_len.clone(),
